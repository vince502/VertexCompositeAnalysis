...
// Class:      OniaV0Fitter
// 
/**\class OniaV0Fitter OniaV0Fitter.h VertexCompositeAnalysis/VertexCompositeProducer/interface/OniaV0Fitter.h
...
class OniaV0Fitter {
 public:
  OniaV0Fitter(const edm::ParameterSet& theParams, edm::ConsumesCollector && iC);
  ~OniaV0Fitter();
