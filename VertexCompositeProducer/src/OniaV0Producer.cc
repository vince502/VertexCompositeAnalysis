...
#include "VertexCompositeAnalysis/VertexCompositeProducer/interface/OniaV0Producer.h"

// Constructor
OniaV0Producer::OniaV0Producer(const edm::ParameterSet& iConfig) :
...
// Producer Method
void OniaV0Producer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
   using namespace edm;
