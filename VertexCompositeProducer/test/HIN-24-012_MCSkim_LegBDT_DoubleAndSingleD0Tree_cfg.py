...
'/store/user/soohwan/Analysis/DDbarpPb/RECOAODSIM_MC_PromptD0_EvtGen_MOD_DDbar_PbPemb_Vandy_27Nov2024_v1_partialv2/PromptDoubleD0_Pythia8_SoftQCD_8TeVpPb_8_0_30/RECOAODSIM_MC_PromptD0_EvtGen_MOD_DDbar_PbPemb_Vandy_27Nov2024_v1_partialv2/241128_132551/0000/HIN-pPb816Summer16DR-00033_67.root',
)
)
...
# process.generalD0CandidatesNew.tkChi2Cut = cms.double(7.0)
...
process.generalD0CandidatesNew.tkPtErrCut = cms.double(0.10)
...
process.generalD0CandidatesNew.dAbsYCut = cms.double(1.05)
process.generalD0CandidatesNew.useAnyMVA = cms.bool(True)
process.generalD0CandidatesNew.mvaCut = cms.double(-1.1)
...
process.generalDDCandidatesNew.tkPtSumCut = cms.double(0.0)
process.generalDDCandidatesNew.tkEtaDiffCut = cms.double(999.0)
process.generalDDCandidatesNew.tkNhitsCut = cms.int32(0)
process.generalDDCandidatesNew.tkChi2Cut = cms.double(0)
...
process.generalDDCandidatesNew.BDTCut = cms.double(0.3)
...
process.d0selectorMCNewReduced.trkPtMin = cms.untracked.double(0.5)
...
process.d0selectorMCNewReduced.candYMin = cms.untracked.double(-1.51)
process.d0selectorMCNewReduced.candYMax = cms.untracked.double(1.51)
...
process.d0ana_mc_newreduced.VertexCompositeCollection = cms.untracked.InputTag("generalD0CandidatesNew:D0")
process.d0ana_mc_newreduced.MVACollection = cms.InputTag("generalD0CandidatesNew:MVAValuesD0")
process.d0ana_mc_newreduced.DCAValCollection = cms.InputTag("generalD0CandidatesNew:DCAValuesD0")
process.d0ana_mc_newreduced.DCAErrCollection = cms.InputTag("generalD0CandidatesNew:DCAErrorsD0")
process.d0ana_mc_newreduced.Angle2D = cms.InputTag("generalD0CandidatesNew:Angle2D")
process.d0ana_mc_newreduced.Angle3D = cms.InputTag("generalD0CandidatesNew:Angle3D")
process.d0ana_mc_newreduced.MVACollection2= cms.InputTag("")
process.d0ana_mc_newreduced.debug= False
process.d0ana_mc_newreduced.onlyWantMatch= False
...
process.d0ana_seq2 = cms.Sequence(process.eventFilter_HM * process.d0ana_mc_newreduced * process.generalDDCandidatesNew * process.ddana_new  )
# process.d0ana_seq2 = cms.Sequence(process.eventFilter_HM * process.d0ana_mc_newreduced * process.generalDDCandidatesNew )
...
process.options.numberOfThreads = cms.uint32(1)
