...
config.General.requestName = "D04P_CMSSW_14_1_9_21Sep_2025_v1_test"
...
config.JobType.psetName = "pp2024_D04PAndDStar5P_MB_cfg_v1.py"
...
config.Data.outLFNDirBase = '/store/user/soohwan/store/ppRef2024/D04P/%s' % (config.General.requestName)
