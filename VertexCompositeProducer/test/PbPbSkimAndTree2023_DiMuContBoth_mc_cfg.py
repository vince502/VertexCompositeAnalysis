...
process.source = cms.Source("PoolSource",
   fileNames = 
cms.untracked.vstring('file:/eos/cms/store/group/phys_heavyions/jiazhao/STARlight/Reco/STARlight_CohJpsi_Reco/STARlight_CohJpsi2MuMu_PbPb5TeV_GenFilter/STARlight_CohJpsi_Reco/230510_185050/0000/step3_STARlight_Reco_101.root'),
...
process.generalDiMuCandidatesWrongSign = process.generalDiMuCandidates.clone(isWrongSign 
= cms.bool(True))
...
process.cent_seq)
process.dimurereco_step = cms.Path(process.offlinePrimaryVerticesRecovery * 
process.patMuonSequence * process.generalDiMuCandidates)
process.dimurerecowrongsign_step = cms.Path(process.offlinePrimaryVerticesRecovery * 
process.patMuonSequence * process.generalDiMuCandidatesWrongSign)
...
process.Flag_colEvtSel = cms.Path(process.offlinePrimaryVerticesRecovery * 
process.colEvtSel)
process.Flag_hfCoincFilter2Th4 = cms.Path(process.offlinePrimaryVerticesRecovery * 
process.hfCoincFilter2Th4)
process.Flag_primaryVertexFilter = cms.Path(process.offlinePrimaryVerticesRecovery * 
process.primaryVertexFilter)
process.Flag_clusterCompatibilityFilter = cms.Path(process.offlinePrimaryVerticesRecovery 
* process.clusterCompatibilityFilter)
eventFilterPaths = [ process.Flag_colEvtSel , process.Flag_hfCoincFilter2Th4 , 
process.Flag_primaryVertexFilter , process.Flag_clusterCompatibilityFilter ]
...
process = 
massReplaceInputTag(process,"offlinePrimaryVertices","offlinePrimaryVerticesRecovery")
