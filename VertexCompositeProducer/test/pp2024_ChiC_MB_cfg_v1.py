...
process.ChiCTo4Pi.minTrackPt = cms.double(1.5)
...
process.ChiC2To4K.minTrackPt = cms.double(1.5)
...
process.ChiCTo2Ka.minTrackPt = cms.double(0.0)
process.ChiCTo2Ka.maxTrackEta = cms.double(2.4)
process.ChiCTo2Ka.maxTrackNormalizedChi2 = cms.double(10.0)
process.ChiCTo2Ka.minTrackNHits = cms.int32(6)
process.ChiCTo2Ka.minPairPt = cms.double(1.2)
