...
config.JobType.psetName = "pPbSkimAndTree2016_DoubleD0Both_ForBDT_ForLamC_cfg.py"
...
for i in range(1,2):
    dataMap[("PAMinimumBias"+str(i))] = { "PD": ("/PAMinimumBias"+str(i)+"/PARun2016C-PromptReco-v1/AOD"), "Units": 4, "Memory": 2500, "RunTime": 2400 }

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = key+'_8TeVpPb2016_DmesonSkim_'+date+'_v3'
