...
process.onia2MuMuPatGlbGlb.dimuonSelection = cms.string('mass > 1') 
...
#process.unpackedPixelTracks = process.unpackedTracksAndVertices.clone()
#process.unpackedPixelTracks.recoverTracks = cms.bool(False)
#process.unpackedPixelTracks.packedCandidates = cms.VInputTag(['hiPixelTracks'])
#process.unpackedPixelTracks.packedCandidateNormChi2Map = cms.VInputTag([''])
#process.unpackedPixelTracks.primaryVertices= cms.InputTag('')
...
#process.oniaTreeAna.replace(process.onia2MuMuPatGlbGlb, process.onia2MuMuPatGlbGlb * process.onia2MuMuPatGlbGlbFilter * process.unpackedPixelTracks * process.generalOttCandidatesNew)
