...
process.generalD0CandidatesNew.trkPtSumCut = cms.double(999.0)
...
process.d0selectorNewReduced.GBRForestFileName = cms.string('GBRForestfile_XGBDT_PromptD0InpPb_default_MB_OnlyMC_v1.root')
