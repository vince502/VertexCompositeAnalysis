...
process.generalDStarCandidatesNew.tkPtCut = cms.double(0.6)
process.generalDStarCandidatesNew.alphaCut = cms.double(2.0)
process.generalDStarCandidatesNew.alpha2DCut = cms.double(2.0)
