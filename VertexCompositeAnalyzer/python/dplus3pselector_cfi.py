...
dplus3pselector = cms.EDProducer('VertexCompositeSelector',
  ...
  GBRForestLabel = cms.string('DPlus3PInpPb'),
  GBRForestFileName = cms.string('GBRForestfile_BDT_DPlus3PInpPb_1_2.root'),
...
dplus3pselectorMC = cms.EDProducer('VertexCompositeSelector',
