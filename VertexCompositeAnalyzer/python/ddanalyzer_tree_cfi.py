...
ddana = cms.EDAnalyzer('VertexCompositeTreeProducer',
  ...
  VertexCompositeCollection = cms.untracked.InputTag("generalDDCandidatesNew:DD"),
...
ddana_mc = cms.EDAnalyzer('VertexCompositeTreeProducer',
  doRecoNtuple = cms.untracked.bool(True),
  ...
  threeProngDecay = cms.untracked.bool(False),
  #PID used only for GEN and/or GEN match
  PID = cms.untracked.int32(30443),
  PID_dau1 = cms.untracked.int32(421),
  PID_dau2 = cms.untracked.int32(421),
  deltaR = cms.untracked.double(0.03),
  VertexCollection = cms.untracked.InputTag("offlinePrimaryVertices"),
  TrackCollection = cms.untracked.InputTag("generalTracks"),
  VertexCompositeCollection = cms.untracked.InputTag("generalDDCandidatesNew:DD"),
