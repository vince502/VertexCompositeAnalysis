...
d0ana = cms.EDAnalyzer('PATCompositeTreeProducer3',
  ...
  CompositeCollection = cms.untracked.InputTag("generalD0CandidatesNew:D0"),
...
d0ana_mc = cms.EDAnalyzer('PATCompositeTreeProducer3',
  doRecoNtuple = cms.untracked.bool(True),
