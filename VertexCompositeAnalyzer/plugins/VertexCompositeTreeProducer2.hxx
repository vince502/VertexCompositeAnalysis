...
private:
  ...
  bool matchHadron(const reco::Candidate *_dmeson_,
                   const reco::GenParticle &_gen_) const;
  bool checkSwap(const reco::Candidate *_dmeson_,
                 const reco::GenParticle &_gen_) const;
  bool matchTrackdR(const reco::Candidate *_recoTrk_,
                    const reco::Candidate *_genTrk_, bool chkchrg) const;
  ...
  if (doRecoNtuple_) {
    ...
    if (!isSkimMVA_) {
      ...
      if (twoLayerDecay_) {
        ...
        VertexCompositeNtuple->Branch("VtxNDFdaughter1", &grand_ndf,
                                      "VtxNDFdaughter1[candSize]/F");
        ...
        if (doubleCand_) {
          ...
          //            VertexCompositeNtuple->Branch("VtxChi2daughter1",&grand_vtxChi2,"VtxChi2daughter1[candSize]/F");
          VertexCompositeNtuple->Branch("VtxNDFdaughter2", &grand_ndf2,
                                        "VtxNDFdaughter2[candSize]/F");
          VertexCompositeNtuple->Branch(
...
bool VertexCompositeTreeProducer2::matchHadron(
    const reco::Candidate *_dmeson_, const reco::GenParticle &_gen_) const {
...
bool VertexCompositeTreeProducer2::checkSwap(
    const reco::Candidate *_dmeson_, const reco::GenParticle &_gen_) const {
  return _dmeson_->pdgId() != _gen_.pdgId();
};

bool VertexCompositeTreeProducer2::matchTrackdR(
    const reco::Candidate *_recoTrk_, const reco::Candidate *_genTrk_,
    bool chkchrg) const {
  bool pass = false;
  // deltaR_
#ifdef DEBUG
