...
VertexCompositeTreeProducer2::fillRECO(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  //            VertexCompositeNtuple->Branch("normalizedChi2Daugther2",&trkChi2,"normalizedChi2Daugther2[candSize]/F");
    ...
    if(doGenNtuple_)
    {
        ...
        VertexCompositeNtuple->Branch("gen_mass",&mass_gen,"mass_gen[candSize_gen]/F");
        VertexCompositeNtuple->Branch("gen_pT",&pt_gen,"pT_gen[candSize_gen]/F");
        VertexCompositeNtuple->Branch("gen_eta",&eta_gen,"eta_gen[candSize_gen]/F");
        VertexCompositeNtuple->Branch("gen_phi",&phi_gen,"phi_gen[candSize_gen]/F");
        ...
        if(twoLayerDecay_){
          VertexCompositeNtuple->Branch("gen_D0pT",&gen_D0pT_, "gen_D0pT[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0eta",&gen_D0eta_, "gen_D0eta[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0phi",&gen_D0phi_, "gen_D0phi[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0mass",&gen_D0mass_, "gen_D0mass[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0y",&gen_D0y_, "gen_D0y[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0charge",&gen_D0charge_, "gen_D0charge[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0pdgId",&gen_D0pdgId_, "gen_D0pdgId[candSize_gen]I");

          VertexCompositeNtuple->Branch("gen_D0Dau1_pT",&gen_D0Dau1_pT_, "gen_D0Dau1_pT[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau1_eta",&gen_D0Dau1_eta_, "gen_D0Dau1_eta[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau1_phi",&gen_D0Dau1_phi_, "gen_D0Dau1_phi[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau1_mass",&gen_D0Dau1_mass_, "gen_D0Dau1_mass[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau1_y",&gen_D0Dau1_y_, "gen_D0Dau1_y[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau1_charge",&gen_D0Dau1_charge_, "gen_D0Dau1_charge[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau1_pdgId",&gen_D0Dau1_pdgId_, "gen_D0Dau1_pdgId[candSize_gen]I");

          VertexCompositeNtuple->Branch("gen_D0Dau2_pT",&gen_D0Dau2_pT_, "gen_D0Dau2_pT[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau2_eta",&gen_D0Dau2_eta_, "gen_D0Dau2_eta[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau2_phi",&gen_D0Dau2_phi_, "gen_D0Dau2_phi[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau2_mass",&gen_D0Dau2_mass_, "gen_D0Dau2_mass[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau2_y",&gen_D0Dau2_y_, "gen_D0Dau2_y[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau2_charge",&gen_D0Dau2_charge_, "gen_D0Dau2_charge[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D0Dau2_pdgId",&gen_D0Dau2_pdgId_, "gen_D0Dau2_pdgId[candSize_gen]I");

          VertexCompositeNtuple->Branch("gen_D1pT",&gen_D1pT_, "gen_D1pT[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D1eta",&gen_D1eta_, "gen_D1eta[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D1phi",&gen_D1phi_, "gen_D1phi[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D1mass",&gen_D1mass_, "gen_D1mass[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D1y",&gen_D1y_, "gen_D1y[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D1charge",&gen_D1charge_, "gen_D1charge[candSize_gen]F");
          VertexCompositeNtuple->Branch("gen_D1pdgId",&gen_D1pdgId_, "gen_D1pdgId[candSize_gen]I");
        }
    }
}
