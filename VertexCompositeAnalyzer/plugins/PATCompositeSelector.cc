...
void PATCompositeSelector::produce(edm::Event &iEvent, const edm::EventSetup &iSetup) {
  using std::vector;
  using namespace edm;
...
void PATCompositeSelector::fillRECO(edm::Event &iEvent, const edm::EventSetup &iSetup) {
  // get collections
...
int PATCompositeSelector::muAssocToTrack(const reco::TrackRef &trackref,
