...
process.gbrForestWriter = cms.EDAnalyzer("GBRForestWriter",
    jobs = cms.VPSet(
        cms.PSet(
            inputFileName = cms.FileInPath('/afs/cern.ch/work/s/soohwan/private/Analysis/DmesonAna/2023Analysis/DStarJunseok/el9/CMSSW_13_2_13/src/VertexCompositeAnalysis/VertexCompositeProducer/data/xgboost_D0Model_15Params_V1_08Mar.xml'),
		...
		'f0', 'f1', 'f2', 'f3', 'f4', 'f5', 'f6', 'f7', 'f8', 'f9', 'f10', 'f11', 'f12', 'f13', 'f14'
            ...
            outputFileName = cms.string("GBRForestfile_XGBDT_PromptD0InPbPb_15Params_v1_08Mar.root")
        )
    )
)
